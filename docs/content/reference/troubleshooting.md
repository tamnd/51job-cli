...
Most of these come down to network reality or how 51job serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

51job rate-limits like any public site. job51 already paces
...
Where a surface is gated, job51 reads a cookie or token you supply
...
`job51`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what job51 actually did
